...
ONBOARDING_STEPS = [
    ...
    },
    {
        ...
        "body": "Два предустановленных профиля позволяют сравнить низкий и высокий риск без ручного подбора всех полей.",
    },
    {
...
FEATURE_HELP = {
    ...
    "status": "Статус клиента в исходных данных: 1 или 2.",
    "age": "Возраст клиента.",
